    ...
    <div className="view view-forecast">
      <div className="forecast-layout">
        ...
        <div className="forecast-stage">
          ...
          {loading && <div className="forecast-status">LOADING...</div>}
          {error && <div className="forecast-status forecast-status-error">{error}</div>}
          {!loading && !error && (
        ...
        <section className="forecast-readout">
          ...
          {forecastRows.length === 0 && !loading ? (
            <p className="forecast-empty">
              No forecast available. Run <code>make train-forecast</code>
              to generate it from the current flow data.
            </p>
          ) : (
